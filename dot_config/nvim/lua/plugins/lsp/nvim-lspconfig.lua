return {
  { -- LSP Configuration & Plugins
    ...
    dependencies = {
      ...
      -- TODO: neodev.nvim is no longer maintained and is replaced by lazydev.nvim
    ...
    config = function()
      ...
      -- The loop below is for overriding the default configuration of LSPs with the
      -- ones in the servers table
